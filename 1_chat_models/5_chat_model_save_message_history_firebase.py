...
PROJECT_ID = "langchain-datasave"
SESSION_ID = "Session new"  # This could be a username or a unique ID
...
# it can store the previous chat_history prefect for making a chat_bot